              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="mt-1 px-7 block w-full border-[1px] h-[50px] rounded-md border-slate-400 shadow-sm "
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="mt-1 border-[1px] h-[50px] px-5 block w-full rounded-md border-gray-400 shadow-sm"
                  />
                </div>
                <div>
